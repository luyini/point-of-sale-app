...
def matching_product(product_identifier):
    product_list = [p for p in products if p["id"] == product_identifier]
...
print("----------------------------------")
print("IVY'S GROCERY STORE")
print("----------------------------------")
print("Web: www.ivystore.com")
print("Phone: 1.646.983.8499")
print("Instagram: ivyivyivyjustme")
...
print("----------------------------------")
print("Thank you for shopping with us! Hope to see you next time ：）")
